...
# Dependencies
This program needs a dotNET Framework (v4, but it's backwards compatable AFAIK), a Winforms desktop development SDK (since it is a form app), and the Newtonsoft Json package for storage.
